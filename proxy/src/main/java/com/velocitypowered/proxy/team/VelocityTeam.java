...
import com.velocitypowered.proxy.protocol.packet.teams.GenericTeamPacket;
...
public class VelocityTeam implements Team {
  ...
  public VelocityTeam(VelocityServer server, String name, Component displayName, Component prefix, Component suffix,
      TeamColor color, boolean allowFriendlyFire, boolean canSeeFriendlyInvisibles, NameTagVisibility nameTagVisibility,
      CollisionRule collisionRule, Set<String> entries) {
    this.server = server;
    this.name = name;
  ...
  /**
   * This method will create and return a filled {@link CreateTeamPacket} for this team.
   *
   * @return a filled {@link CreateTeamPacket} for this team
   */
  public CreateTeamPacket getCreationPacket() {
    ...
    int friendlyFlags = (allowFriendlyFire ? 1 : 0) + (canSeeFriendlyInvisibles ? 2 : 0);
    ...
    return new CreateTeamPacket(name, displayName, friendlyFlags, nameTagVisibility, collisionRule,
        teamColor, teamPrefix, teamSuffix, entries);
  }

  /**
   * This method will create and return a filled {@link RemoveTeamPacket} for this team.
   *
   * @return a filled {@link RemoveTeamPacket} for this team
   */
  public RemoveTeamPacket getRemovalPacket() {
    return new RemoveTeamPacket(name);
  }

  /**
   * This method will create and return a filled {@link UpdateTeamPacket} for this team.
   * @return a filled {@link UpdateTeamPacket} for this team
   */
  public UpdateTeamPacket getUpdatePacket() {
    GsonComponentSerializer serializer = ProtocolUtils.getJsonChatSerializer(ProtocolVersion.MAXIMUM_VERSION);
    ...
    return new UpdateTeamPacket(name, displayName, friendlyFlags, nameTagVisibility, collisionRule,
        teamColor, teamPrefix, teamSuffix);
  }

  /**
   * This method will create and return a filled {@link AddEntitiesToTeamPacket} for this team.
   *
   * @param entries the entries in the packet
   * @return a filled {@link AddEntitiesToTeamPacket} for this team
   */
  public AddEntitiesToTeamPacket getAddEntriesPacket(Set<String> entries) {
    return new AddEntitiesToTeamPacket(name, entries);
  }

  /**
   * This method will create and return a filled {@link RemoveEntitiesFromTeamPacket} for this team.
   *
   * @param entries the entries in the packet
   * @return a filled {@link RemoveEntitiesFromTeamPacket} for this team
   */
  public RemoveEntitiesFromTeamPacket getRemoveEntriesPacket(Set<String> entries) {
    return new RemoveEntitiesFromTeamPacket(name, entries);
  }
   ...
   *
   * @param packet the packet to broadcat
   */
  private void broadcast(GenericTeamPacket packet) {
