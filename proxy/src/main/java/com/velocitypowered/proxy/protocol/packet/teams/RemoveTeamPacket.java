...
public class RemoveTeamPacket extends GenericTeamPacket {

  /**
   * Creates a new instance.
   */
  public RemoveTeamPacket() {
    super(ActionType.REMOVE_TEAM);
  }
   ...
   */
  public RemoveTeamPacket(String name) {
    super(ActionType.REMOVE_TEAM, name);
  }
